...
public class CustomSpinnerAdapter extends ArrayAdapter<CustomSpinnerList> {

    Context context;
    ArrayList<CustomSpinnerList> arrayList;

    public CustomSpinnerAdapter(CustomSpinnerActivity customSpinnerActivity, ArrayList<CustomSpinnerList> arrayList) {
